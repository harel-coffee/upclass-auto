...
source_dir = '/data/user/teodoro/uniprot/dataset/pub_data/processed/tag'
...
train_regressors = train_set[2]
dev_regressors = dev_set[2]
test_regressors = test_set[2]

scaler = MinMaxScaler()
train_regressors = scaler.fit_transform(train_regressors)
dev_regressors = scaler.transform(dev_regressors)
test_regressors = scaler.transform(test_regressors)
...
fig.savefig('pca_no_tag_cols.png', bbox_inches='tight', dpi=300)
plt.close()
